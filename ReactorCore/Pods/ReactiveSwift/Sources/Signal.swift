...
public final class Signal<Value, Error: Swift.Error> {
    ...
    private final class Core {
        ...
        fileprivate init(_ generator: (Observer, Lifetime) -> Void) {
            ...
            generator(Observer(action: send, interruptsOnDeinit: true), Lifetime(disposable))
        }
...
extension Signal {
    ...
    private final class CombineLatestStrategy: SignalAggregateStrategy {
        ...
        func update(_ value: Any, at position: Int) {
            ...
            if completion.value == count, lock.try() {
                action(.completed)
                lock.unlock()
            }
        }

        func complete(at _: Int) {
    ...
    private final class ZipStrategy: SignalAggregateStrategy {
        ...
        init(count: Int, action: @escaping (AggregateStrategyEvent) -> Void) {
            ...
            hasConcurrentlyCompleted = false
    ...
    private convenience init<Strategy: SignalAggregateStrategy, U, S: Sequence>(_: Strategy.Type, _ signals: S) where Value == [U], S.Iterator.Element == Signal<U, Error> {
        self.init(signals.reduce(AggregateBuilder<Strategy>()) { $0.add($1) }) { $0.map { $0 as! U } }
    }

    private convenience init<Strategy: SignalAggregateStrategy, A, B>(_: Strategy.Type, _ a: Signal<A, Error>, _ b: Signal<B, Error>) where Value == (A, B) {
        self.init(AggregateBuilder<Strategy>().add(a).add(b)) {
            ($0[0] as! A, $0[1] as! B)
        }
    }

    private convenience init<Strategy: SignalAggregateStrategy, A, B, C>(_: Strategy.Type, _ a: Signal<A, Error>, _ b: Signal<B, Error>, _ c: Signal<C, Error>) where Value == (A, B, C) {
        self.init(AggregateBuilder<Strategy>().add(a).add(b).add(c)) {
            ($0[0] as! A, $0[1] as! B, $0[2] as! C)
        }
    }

    private convenience init<Strategy: SignalAggregateStrategy, A, B, C, D>(_: Strategy.Type, _ a: Signal<A, Error>, _ b: Signal<B, Error>, _ c: Signal<C, Error>, _ d: Signal<D, Error>) where Value == (A, B, C, D) {
        self.init(AggregateBuilder<Strategy>().add(a).add(b).add(c).add(d)) {
            ($0[0] as! A, $0[1] as! B, $0[2] as! C, $0[3] as! D)
        }
    }

    private convenience init<Strategy: SignalAggregateStrategy, A, B, C, D, E>(_: Strategy.Type, _ a: Signal<A, Error>, _ b: Signal<B, Error>, _ c: Signal<C, Error>, _ d: Signal<D, Error>, _ e: Signal<E, Error>) where Value == (A, B, C, D, E) {
        self.init(AggregateBuilder<Strategy>().add(a).add(b).add(c).add(d).add(e)) {
            ($0[0] as! A, $0[1] as! B, $0[2] as! C, $0[3] as! D, $0[4] as! E)
        }
    }

    private convenience init<Strategy: SignalAggregateStrategy, A, B, C, D, E, F>(_: Strategy.Type, _ a: Signal<A, Error>, _ b: Signal<B, Error>, _ c: Signal<C, Error>, _ d: Signal<D, Error>, _ e: Signal<E, Error>, _ f: Signal<F, Error>) where Value == (A, B, C, D, E, F) {
    ...
    private convenience init<Strategy: SignalAggregateStrategy, A, B, C, D, E, F, G>(_: Strategy.Type, _ a: Signal<A, Error>, _ b: Signal<B, Error>, _ c: Signal<C, Error>, _ d: Signal<D, Error>, _ e: Signal<E, Error>, _ f: Signal<F, Error>, _ g: Signal<G, Error>) where Value == (A, B, C, D, E, F, G) {
    ...
    private convenience init<Strategy: SignalAggregateStrategy, A, B, C, D, E, F, G, H>(_: Strategy.Type, _ a: Signal<A, Error>, _ b: Signal<B, Error>, _ c: Signal<C, Error>, _ d: Signal<D, Error>, _ e: Signal<E, Error>, _ f: Signal<F, Error>, _ g: Signal<G, Error>, _ h: Signal<H, Error>) where Value == (A, B, C, D, E, F, G, H) {
    ...
    private convenience init<Strategy: SignalAggregateStrategy, A, B, C, D, E, F, G, H, I>(_: Strategy.Type, _ a: Signal<A, Error>, _ b: Signal<B, Error>, _ c: Signal<C, Error>, _ d: Signal<D, Error>, _ e: Signal<E, Error>, _ f: Signal<F, Error>, _ g: Signal<G, Error>, _ h: Signal<H, Error>, _ i: Signal<I, Error>) where Value == (A, B, C, D, E, F, G, H, I) {
...
extension Signal where Error == NoError {
    ...
    public func timeout<NewError>(
        ...
        return promoteError(NewError.self)
...
extension Signal where Value == Bool {
    ...
    public func and(_ signal: Signal<Value, Error>) -> Signal<Value, Error> {
        return combineLatest(with: signal).map { $0.0 && $0.1 }
    }
...
extension Signal where Error == NoError {
    ...
    public func attempt(_ action: @escaping (Value) throws -> Void) -> Signal<Value, AnyError> {
        return promoteError(AnyError.self)
            .attempt(action)
    }
